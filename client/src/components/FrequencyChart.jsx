...
const Grid = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "repeating-linear-gradient(black 0 1px, transparent 1px 100%), repeating-linear-gradient(90deg, black 0 1px, transparent 1px 100%)",
  ...
  return (
    <div
      ...
      style={{
        ...
        top: `${100 - x}%`,
        left: `${y}%`,
        backgroundColor: color ? `#${color}` : "#00ff00",
      }}
    />
  );
};
...
const FrequencyChart = ({ title, data, color }) => {
  ...
  return (
    <>
      <h4>{title}</h4>
      <div
        className="w-100 ps-5 pb-5 mb-1"
        style={{
          height: "400px",
        }}
      >
        <div
          className="w-100 h-100 bg-light position-relative"
